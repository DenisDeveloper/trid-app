...
(function(process) {
  THREE.GLTFLoaderUtils = Object.create(Object, {
    ...
    _loadStream: {value: function(path, type, delegate) {
        var self = this;
        if (!type) {
    ...
    _handleRequest: {value: function(request) {
    ...
    _elementSizeForGLType: {value: function(glType) {
        switch (glType) {
    ...
    _handleWrappedBufferViewResourceLoading: {value: function(wrappedBufferView, delegate, ctx) {
    ...
    getBuffer: {value: function(wrappedBufferView, delegate, ctx) {
    ...
    getFile: {value: function(request, delegate, ctx) {
