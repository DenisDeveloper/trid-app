...
(function(process) {
  ...
  THREE.glTFLoader.prototype.load = function(url, callback) {
    ...
    var ThreeGLTFLoader = Object.create(glTFParser, {
      ...
      handleBuffer: {value: function(entryID, description, userInfo) {
          this.resources.setEntry(entryID, null, description);
          description.type = "ArrayBuffer";
          return true;
        }},
      handleBufferView: {value: function(entryID, description, userInfo) {
          this.resources.setEntry(entryID, null, description);
      ...
      handleShader: {value: function(entryID, description, userInfo) {
          this.resources.setEntry(entryID, null, description);
          var shaderRequest = {
            id: entryID,
      ...
      handleProgram: {value: function(entryID, description, userInfo) {
          this.resources.setEntry(entryID, null, description);
          return true;
        }},
      handleTechnique: {value: function(entryID, description, userInfo) {
          this.resources.setEntry(entryID, null, description);
          return true;
        }},
      createShaderMaterial: {value: function(material) {
      ...
      createShaderParams: {value: function(materialId, values, params, instanceProgram) {
      ...
      threeJSMaterialType: {value: function(materialId, technique, values, params) {
          ...
          var shininess = values.shininesss || values.shininess;
          if (shininess) {
            shininess = shininess;
          }
      ...
      handleMaterial: {value: function(entryID, description, userInfo) {
      ...
      handleMesh: {value: function(entryID, description, userInfo) {
          var mesh = new Mesh();
      ...
      handleCamera: {value: function(entryID, description, userInfo) {
          var camera;
      ...
      handleLight: {value: function(entryID, description, userInfo) {
          var light = null;
      ...
      addPendingMesh: {value: function(mesh, threeNode) {
          theLoader.pendingMeshes.push({
            mesh: mesh,
            node: threeNode
          });
        }},
      handleNode: {value: function(entryID, description, userInfo) {
          var threeNode = null;
                    ...
                    if (threeMesh && dobones) {
                      ...
                      for (i = 0; i < len; i++) {
                        ...
                        if (joint) {
                          ...
                          var mat = new THREE.Matrix4().set(m[i * 16 + 0], m[i * 16 + 4], m[i * 16 + 8], m[i * 16 + 12], m[i * 16 + 1], m[i * 16 + 5], m[i * 16 + 9], m[i * 16 + 13], m[i * 16 + 2], m[i * 16 + 6], m[i * 16 + 10], m[i * 16 + 14], m[i * 16 + 3], m[i * 16 + 7], m[i * 16 + 11], m[i * 16 + 15]);
      ...
      buildSkins: {value: function(node) {
      ...
      createMeshAnimations: {value: function(root) {
          this.buildSkins(root);
        }},
      handleScene: {value: function(entryID, description, userInfo) {
      ...
      handleImage: {value: function(entryID, description, userInfo) {
          this.resources.setEntry(entryID, null, description);
          return true;
        }},
      addNodeAnimationChannel: {value: function(name, channel, interp) {
      ...
      handleAnimation: {value: function(entryID, description, userInfo) {
          var self = this;
      ...
      handleAccessor: {value: function(entryID, description, userInfo) {
          this.resources.setEntry(entryID, description, description);
          return true;
        }},
      handleSkin: {value: function(entryID, description, userInfo) {
          var skin = {};
      ...
      handleSampler: {value: function(entryID, description, userInfo) {
          this.resources.setEntry(entryID, description, description);
          return true;
        }},
      handleTexture: {value: function(entryID, description, userInfo) {
          this.resources.setEntry(entryID, null, description);
          return true;
        }},
      handleError: {value: function(msg) {
          throw new Error(msg);
          return true;
        }},
      _delegate: {
