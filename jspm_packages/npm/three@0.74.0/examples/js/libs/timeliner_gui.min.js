...
(function e(t, n, r) {
  ...
  1: [function(require, module, exports) {
    ...
    "object" == typeof module && (module.exports = Do);
  }, {}],
  2: [function(require, module, exports) {
    module.exports = {
      ...
      "license": "MIT",
      "bugs": {"url": "https://github.com/tschw/timeliner_gui/issues"},
  ...
  4: [function(require, module, exports) {
    function LayerCabinet(e) {
      ...
      style(s.dom, l, {marginTop: "2px"}), s.onClick(function(e) {
        e.preventDefault(), d.fire("controls.toggle_play");
      });
      var u = new IconButton(16, "stop", "Stop", d);
      style(u.dom, l, {marginTop: "2px"}), u.onClick(function(e) {
      ...
      style(v, {marginTop: "4px"}), a.appendChild(v);
  ...
  9: [function(require, module, exports) {
    ...
    function Timeliner(e) {
      ...
      function s() {
        var t = e.serialize(),
            n = "animation.json";
        saveToFile(JSON.stringify(t, null, "	"), n);
      }
      function l(t) {
        e.deserialize(t), c();
      }
      ...
      function g(e, t) {
        e.style.cssText = "position: absolute; left: 0px; top: 0px; height: " + w.height + "px;", style(e, {overflow: "hidden"}), e.style.width = LayoutConstants.LEFT_PANE_WIDTH + "px", t.style.position = "absolute", t.style.top = "0px", t.style.left = LayoutConstants.LEFT_PANE_WIDTH + "px";
      }
      ...
      style(R, _, {textAlign: "right"}), k.appendChild(R);
      var A = new IconButton(10, "resize_full", "Maximize", f);
      style(A.dom, S, {marginRight: "2px"}), R.appendChild(A.dom);
      ...
      style(D, W, {textAlign: "right"}), M.appendChild(z), M.appendChild(D);
    ...
    var undo = require('./undo'),
        ...
        package_json = require('../package.json!systemjs-json'),
        IconButton = require('./widget/icon_button'),
        style = utils.style,
  ...
  13: [function(require, module, exports) {
    function IconButton(e, t, n, o) {
      ...
      var r = document.createElement("canvas"),
          a = r.getContext("2d");
      i.appendChild(r), this.ctx = a, this.dom = i, this.canvas = r;
      var d = this;
      this.size = e;
      var l = 1;
      this.resize = function() {
        ...
        var n = e,
            o = font.fonts[t];
        r.height = n * l, r.style.height = n + "px";
        var s = n / font.unitsPerEm,
            i = o.advanceWidth * s + .5 | 0;
        i += 2, n += 2, r.width = i * l, r.style.width = i + "px", a.fillStyle = Theme.c, d.draw();
      }, o && o.on("resize", this.resize), this.setSize = function(t) {
        e = t, this.resize();
      }, this.setIcon = function(e) {
        d.icon = e, font.fonts[e] || console.error("Font icon not found!"), this.resize();
      ...
      this.onLongHold = function(e) {
        function t(t) {
          t.preventDefault(), t.stopPropagation(), c = setTimeout(function() {
            c && e();
          }, h);
        }
        function n() {
        ...
        i.addEventListener("mousedown", t), i.addEventListener("touchstart", t), i.addEventListener("mouseup", n), i.addEventListener("mouseout", n), i.addEventListener("touchend", n);
      }, this.setTip = function(e) {
        n = e;
      };
      var u = {border: "1px solid " + Theme.b},
          f = {border: "1px solid transparent"},
          v = "none",
          m = (Theme.c, Theme.b);
      i.style.background = v, style(i, f), i.addEventListener("mouseover", function() {
        style(i, u), a.fillStyle = Theme.d, a.shadowColor = Theme.b, a.shadowBlur = .5 * l, a.shadowOffsetX = 1 * l, a.shadowOffsetY = 1 * l, d.draw(), n && o && o.fire("status", n);
      }), i.addEventListener("mousedown", function() {
        i.style.background = m;
      }), i.addEventListener("mouseup", function() {
        i.style.background = v, style(i, u);
      }), i.addEventListener("mouseout", function() {
        i.style.background = v, style(i, f), d.dropshadow = !1, a.fillStyle = Theme.c, a.shadowColor = null, a.shadowBlur = 0, a.shadowOffsetX = 0, a.shadowOffsetY = 0, d.draw();
      }), t && this.setIcon(t);
    }
    var font = require('./font.json!systemjs-json'),
        Theme = require('../theme'),
        style = require('../utils').style,
        dp;
    IconButton.prototype.CMD_MAP = {
      ...
      if (this.icon) {
        var e = this.ctx,
            t = font.fonts[this.icon],
            n = this.size,
            o = window.devicePixelRatio,
            s = n / font.unitsPerEm * o,
            i = t.commands.split(" ");
        if (e.save(), e.clearRect(0, 0, this.canvas.width * o, this.canvas.height * o), this.dropshadow) {
          e.save(), e.fillStyle = Theme.b, e.translate(1.5 * o, 1.5 * o), e.scale(s, -s), e.translate(0, -font.ascender), e.beginPath();
          for (var r = 0,
              a = i.length; a > r; r++) {
            var d = i[r].split(","),
                l = d.slice(1);
            e[this.CMD_MAP[d[0]]].apply(e, l);
          }
          e.fill(), e.restore();
        }
        e.scale(s, -s), e.translate(0, -font.ascender), e.beginPath();
        for (var r = 0,
            a = i.length; a > r; r++) {
          var d = i[r].split(","),
              l = d.slice(1);
    ...
    function NumberUI(e) {
      ...
      function t(e) {
        var n = e.dx,
            t = e.dy,
            i = 1 * a;
        h = s + n * i + t * -i, h = Math.max(r, h), c.onChange.fire(h, !0);
      }
      function i(e) {
        s = h;
      }
      ...
      var s,
          c = this,
          h = 0;
      this.onChange = new Do, d.addEventListener("change", function(e) {
        h = parseFloat(d.value, 10), o();
      }), handleDrag(d, i, t, n), this.dom = d, this.setValue = function(e) {
        h = e;
      }, this.paint = function() {
        null != h && (d.value = h.toFixed(u));
      };
    }
    var Theme = require('../theme'),
        Do = require('do.js'),
  ...
  15: [function(require, module, exports) {
    function ScrollBar(t, e, o) {
      function r(t) {
        t.preventDefault(), t.target == d ? (g = t.clientY, document.addEventListener("mousemove", i, !1), document.addEventListener("mouseup", l, !1)) : t.clientY < m ? v.onScroll.fire("pageup") : t.clientY > m + h && v.onScroll.fire("pagedown");
      }
      function i(t) {
        t.preventDefault();
        var e = p - h,
            o = (t.clientY - g) / e;
        o > 1 && (o = 1), 0 > o && (o = 0), v.setPosition(o), v.onScroll.fire("scrollto", o);
      }
      function l(t) {
        i(t), document.removeEventListener("mousemove", i, !1), document.removeEventListener("mouseup", l, !1);
      }
      var n = e ? e : 12,
          s = 3,
          a = n + 2 * s,
      ...
      utils.style(u, scrolltrack_style);
      var p = t - 2;
      u.style.height = p + "px", u.style.width = a + "px";
      var d = document.createElement("div");
      utils.style(d, scrollbar_style), d.style.width = n + "px", d.style.height = t / 2, d.style.top = 0, d.style.left = s + "px", u.appendChild(d);
      var h,
          m,
          v = this;
      this.setLength = function(t) {
        t = Math.max(Math.min(1, t), 0), t *= p, h = Math.max(t, c), d.style.height = h + "px";
      }, this.setHeight = function(e) {
        t = e, p = t - 2, u.style.height = p + "px";
      }, this.setPosition = function(t) {
        t = Math.max(Math.min(1, t), 0);
        var e = p - h;
        m = t * e, d.style.top = m;
      }, this.setLength(1), this.setPosition(0), this.onScroll = new SimpleEvent;
      var g;
      u.addEventListener("mousedown", r, !1), this.dom = u;
    }
