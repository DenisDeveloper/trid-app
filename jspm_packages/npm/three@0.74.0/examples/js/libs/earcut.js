...
(function(process) {
  ...
  function cureLocalIntersections(data, start, triangles, dim) {
    ...
    do {
      var a = node.prev,
          b = node.next.next;
      if (a.i !== b.i && intersects(data, a.i, node.i, node.next.i, b.i) && locallyInside(data, a, b) && locallyInside(data, b, a) && orient(data, a.i, node.i, b.i) && orient(data, a.i, node.next.i, b.i)) {
  ...
  function isValidDiagonal(data, a, b) {
    return a.next.i !== b.i && a.prev.i !== b.i && !intersectsPolygon(data, a, a.i, b.i) && locallyInside(data, a, b) && locallyInside(data, b, a) && middleInside(data, a, a.i, b.i);
  }
